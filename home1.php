                    ...
                    <div class="row">
                        ...
                        <div class="alert alert-success col-md-3 ml-4">
                            ...
                            <p class="text-right"><b><large>
                                <?php 
                                include 'db_connect.php'; // Make sure the db_connect.php file is correctly configured
                                $today = date('Y-m-d');
                                $result = $conn->query("SELECT SUM(total_amount) AS amount, 
                                                       COUNT(id) AS count, 
                        ...
                        <div class="alert alert-info col-md-3 ml-4">
                            ...
                            <p class="text-right"><b><large>
                                <?php 
                                include 'db_connect.php'; // Same as above, ensures the connection is in place
                                $result = $conn->query("SELECT count(id) AS count FROM laundry_list 
